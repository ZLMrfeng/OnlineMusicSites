...
<script type="text/javascript" src="../js/informationList.js"  charset="UTF-8"></script>
<script>
    layui.config({
    ...
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider'], function(){
        ...
        table.render({
            elem: '#demo'
            ,height: 420
            ,url: '${pageContext.request.contextPath}/backstage/informationManager.do' //数据接口
            ,title: '用户表'
            ,page: true //开启分页
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'informationId', title: 'ID', width:80, sort: true, fixed: 'left', totalRow:true }
                ,{field: 'informationTitle', title: '标题', width:322}
                ,{field: 'informationIntroduction', title: '详细内容', width:322}
                ,{fixed: 'right', width: 322, align:'center', toolbar: '#barDemo'}
            ]],
            ...
            switch(obj.event){
                ...
                case 'update':
                    if(data.length === 0){
                        ...
                        editInformation(checkStatus.data[0]);
                    }
                    break;
                case 'delete':
                    if(data.length === 0){
        ...
        table.on('tool(test)', function(obj){
            ...
            if(layEvent === 'detail'){
                ...
                layer.confirm('真的删除行么', function(index){
                    ...
                    console.log(data);
                    $.ajax({
                        url:"${pageContext.request.contextPath}/backstage/delInformationManager.do",
                        type:"POST",
                        data:{"informationId":data.informationId},
                        dataType:"json",
                ...
                layer.open({
                    ...
                    yes: function (index, layero) {
                        ...
                        $.post('${basePath}informationEdit.do', formData, function (data) {
