...
<script type="text/javascript" src="../js/userTypeList.js"  charset="UTF-8"></script>
<script>
    layui.config({
    ...
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider'], function(){
        ...
        table.render({
            elem: '#demo'
            ,height: 420
            ,url: '${pageContext.request.contextPath}/backstage/userTypeManager.do' //数据接口
            ,title: '用户表'
            ,page: true //开启分页
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'userTypeId', title: 'ID', width:80, sort: true, fixed: 'left', totalRow: true}
                ,{field: 'userTypeName', title: '用户类型', width:120, sort: true, fixed: 'left', totalRow: true}
            ...
            switch(obj.event){
                ...
                case 'update':
                    if(data.length === 0){
                        ...
                        editUserType(checkStatus.data[0]);
                    }
                    break;
                case 'delete':
                    if(data.length === 0){
        ...
        table.on('tool(test)', function(obj){
            ...
            if(layEvent === 'detail'){
                ...
                layer.confirm('真的删除行么', function(index){
                    ...
                    console.log(data);
                    $.ajax({
                        url:"${pageContext.request.contextPath}/backstage/delUserTypeManager.do",
                        type:"POST",
                ...
                layer.open({
                    ...
                    yes: function (index, layero) {
                        ...
                        $.post('${basePath}userTypeEdit.do', formData, function (data) {
