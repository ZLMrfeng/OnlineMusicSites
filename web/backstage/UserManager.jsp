...
<script>
    ...
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider', 'form'], function () {
        ...
        table.render({
            elem: '#demo'
            , height: 420
            , url: '${pageContext.request.contextPath}/backstage/UserManager.do' //数据接口
            , title: '用户表'
            , page: true //开启分页
            ...
            , cols: [[ //表头
                ...
                , {field: 'userId', title: 'ID', width: 80, sort: true, fixed: 'left', totalRow: true}
                , {field: 'userName', title: '用户名', width: 80}
                , {field: 'countName', title: '账号名', width: 80}
                , {field: 'countPassword', title: '密码', width: 80}
                , {field: 'userSex', title: '性别', width: 80, sort: true}
                , {field: 'userEmail', title: '邮箱', width: 80, sort: true}
                , {field: 'userImage', title: '图像', width: 80, sort: true}
                , {field: 'createDate', title: '创建时间', width: 150, sort: true, templet: '#createTime'}
                , {field: 'userTypeId', title: '用户类型', width: 150}
        ...
        table.on('tool(test)', function (obj) {
            ...
            if (layEvent === 'detail') {
                ...
                layer.confirm('真的删除行么', function (index) {
                    ...
                    console.log(data);
                    $.ajax({
                        url: "${pageContext.request.contextPath}/backstage/delUserManager.do",
                        type: "POST",
                ...
                layer.open({
                    ...
                    yes: function (index, layero) {
                        ...
                        $.post('${basePath}userEdit.do', formData, function (data) {
