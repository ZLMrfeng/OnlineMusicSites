function addSpecial(){
	 layer.open({
                    ...
                    content: '<blockquote class="layui-elem-quote layui-text">注意事项: 请填写相关的数据信息! </blockquote>' +
                        ...
                        '<input type="text"  required lay-verify="required" name="specialName"  class="layui-input" >' +
                        '</div></div>' +
                        '</div>' +
                        '<div class="layui-form-item">' +
                        '<div class="layui-inline">' +
                        ...
                        '<div class="layui-input-inline">' +
                        '<input type="text"  required lay-verify="required" name="songId"  class="layui-input" >' +
                        '</div></div>' +
                        '</div>' +
                        '<div class="layui-form-item">' +
                        '<div class="layui-inline">' +
                        ...
                        '<div class="layui-input-inline">' +
                        '<input type="text"  required lay-verify="required" name="specialIntroduction"  class="layui-input"  >' +
                        '</div></div>' +
                        '</div>' +
                        '<div class="layui-form-item">' +
                        '<div class="layui-inline">' +
                        ...
                        '<div class="layui-input-inline">' +
                        '<input type="text"  required lay-verify="required" name="specialImage"  class="layui-input"  >' +
                        '</div></div>' +
                        '</div>' +
                        '<div class="layui-form-item">' +
                        '<div class="layui-inline">' +
                        ...
                        '<div class="layui-input-inline">' +
                        '<input type="text"  required lay-verify="required" name="specialReleseTime"  class="layui-input" >' +
                        '</div></div>' +
                        '</div>' +
                        '<div class="layui-form-item">' +
                        '<div class="layui-inline">' +
                        ...
                        '<div class="layui-input-inline">' +
                        '<input type="text"  required lay-verify="required" name="specialVisitorVolume"  class="layui-input"  >' +
                        '</div></div>' +
                        '</div>' +
                        '</form>',
                    btnAlign: 'c',
                    ...
                    yes: function (index, layero) {
                        ...
                        $.post('/backstage/specialAdd.do', formData, function (data) {
	 ...
	 layer.open({
                    ...
                    yes: function (index, layero) {
                        ...
                        var formData = {
                            ...
                            specialIntroduction: $("input[name='specialIntroduction']").val(),
                            specialReleseTime: $("input[name='specialReleseTime']").val(),
                            specialNumberOfClick: $("input[name='specialNumberOfClick']").val()
                        };
                        console.log(formData);
                        $.post('/backstage/specialEdit.do', formData, function (data) {
