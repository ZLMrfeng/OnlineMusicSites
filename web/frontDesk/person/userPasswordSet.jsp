...
<div class="container">
    ...
    <div class="box">
        ...
        <div class="box2" id="box2-1">
            <form class="form-horizontal" action="${pageContext.request.contextPath}/frontDesk/editPersonalSet.do" method="post">
                <div class="form-group">
                    <div class="col-sm-4">
                        <input type="hidden" class="form-control" name="userId" id="userId" name="userId" placeholder="Hidden" value="${user.userId}">
                    </div>
                </div>
                <div class="form-group">
                    <label for="countNewPassword" class="col-sm-2 control-label">新密码</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="countNewPassword" id="countNewPassword" name="countPassword" placeholder="输入新密码">
                    </div>
                </div>
                <div class="form-group">
                    <label for="countTurePassword" class="col-sm-2 control-label">确认密码</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="countTurePassword" id="countTurePassword" name="countNewPassword" placeholder="再次确认密码" >
                    </div>
                </div>
                <div class="form-group">
